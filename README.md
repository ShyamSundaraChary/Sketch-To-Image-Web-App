...
|-------------|------|---------------------|
| <img src="https://github.com/ShyamSundaraChary.png?size=100" width="100" height="100" style="border-radius: 50%;"><br>**[Shyam Sundara Chary]** | 🎯 **Team Lead & API Integration Specialist** | • Project management and coordination<br>• LightX API integration and optimization<br>• System architecture design<br>• Team workflow supervision |
